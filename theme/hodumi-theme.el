...
;;; hodumi-theme.el --- Tango-dark-based custom theme for faces

;; Copyright (C) 2016 by Hodumi

;; Authors: Hodumi <ajsmithy00@gmail.com>
...
(deftheme hodumi
  "Face colors using the Tango-Dark palette.
...
;; tabbar
   `(tabbar-default ((,class (:background ,alum-5 :foreground ,alum-3 ))))
   `(tabbar-selected ((,class (:background ,alum-2 :foreground ,alum-6 ))))
   `(tabbar-separator ((,class (:background ,alum-6 ))))
